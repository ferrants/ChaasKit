...
export const config: AppConfig = {
  ...
  agent: {
    agents: [
      ...
      },
      {
        ...
        allowedTools: ['native:web-scrape', 'native:get-plan-usage', 'marketplace-ad-pros:*'],
      },
  ...
  mcp: {
    servers: [
      // Marketplace Ad Pros MCP Server (OAuth auto-discovered via RFC 9728/8414)
      {
        id: 'marketplace-ad-pros',
        name: 'Marketplace Ad Pros',
        transport: 'streamable-http',
        url: 'https://app.marketplaceadpros.com/mcp?oai_catalog=1&oai_data_viz=1&oai_quote_estimator=1',
        enabled: true,
        authMode: 'user-oauth',
        userInstructions: 'Connect your Marketplace Ad Pros account to use advertising tools',
      },
